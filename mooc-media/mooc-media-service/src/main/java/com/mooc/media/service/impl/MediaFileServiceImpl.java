package com.mooc.media.service.impl;
...
import com.mooc.base.model.RestResponse;
import com.mooc.media.mapper.MediaFilesMapper;
import com.mooc.media.mapper.MediaProcessMapper;
import com.mooc.media.model.dto.QueryMediaParamsDto;
import com.mooc.media.model.dto.UploadFileParamsDto;
import com.mooc.media.model.dto.UploadFileResultDto;
import com.mooc.media.model.po.MediaFiles;
import com.mooc.media.model.po.MediaProcess;
import com.mooc.media.service.MediaFileService;
import io.minio.*;
...
public class MediaFileServiceImpl implements MediaFileService {
    ...
    public UploadFileResultDto uploadFile(Long companyId, UploadFileParamsDto uploadFileParamsDto, String localFilePath) {
        ...
        if(!result){
            moocPlusException.cast("上传文件失败");
        }
        //入库文件信息
        MediaFiles mediaFiles = currentProxy.addMediaFilesToDb(companyId, fileMd5, uploadFileParamsDto, bucket_mediafiles, objectName);
        if(mediaFiles==null){
            moocPlusException.cast("文件上传后保存信息失败");
        }
        //准备返回的对象
     ...
     * @return com.mooc.media.model.po.MediaFiles
     * @author Mr.M
