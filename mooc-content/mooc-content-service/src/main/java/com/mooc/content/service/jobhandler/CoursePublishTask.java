package com.mooc.content.service.jobhandler;

import com.mooc.base.exception.moocPlusException;
import com.mooc.content.feignclient.CourseIndex;
import com.mooc.content.feignclient.SearchServiceClient;
...
import com.mooc.messagesdk.service.MessageProcessAbstract;
...
public class CoursePublishTask extends MessageProcessAbstract {
    ...
    private void generateCourseHtml(MqMessage mqMessage,long courseId){
        ...
        if(file == null){
            moocPlusException.cast("生成的静态页面为空");
        }
        // 将html上传到minio
    ...
    private void saveCourseIndex(MqMessage mqMessage,long courseId){
        ...
        if(!add){
            moocPlusException.cast("远程调用搜索服务添加课程索引失败");
        }
