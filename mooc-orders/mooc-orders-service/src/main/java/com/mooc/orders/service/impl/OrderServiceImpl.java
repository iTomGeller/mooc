package com.mooc.orders.service.impl;
...
import com.mooc.base.utils.IdWorkerUtils;
import com.mooc.base.utils.QRCodeUtil;
import com.mooc.messagesdk.model.po.MqMessage;
import com.mooc.messagesdk.service.MqMessageService;
import com.mooc.orders.config.AlipayConfig;
import com.mooc.orders.config.PayNotifyConfig;
import com.mooc.orders.mapper.XcOrdersGoodsMapper;
import com.mooc.orders.mapper.XcOrdersMapper;
import com.mooc.orders.mapper.XcPayRecordMapper;
import com.mooc.orders.model.dto.AddOrderDto;
import com.mooc.orders.model.dto.PayRecordDto;
import com.mooc.orders.model.dto.PayStatusDto;
import com.mooc.orders.model.po.XcOrders;
import com.mooc.orders.model.po.XcOrdersGoods;
import com.mooc.orders.model.po.XcPayRecord;
import com.mooc.orders.service.OrderService;
...
public class OrderServiceImpl implements OrderService {
    ...
    public PayRecordDto createOrder(String userId, AddOrderDto addOrderDto) {
        ...
        try {
            ...
            moocPlusException.cast("生成二维码出错");
        }
    ...
    public PayStatusDto queryPayResultFromAlipay(String payNo){
        ...
        try {
            ...
            if(!response.isSuccess()){//交易不成功
                moocPlusException.cast("请求支付宝查询支付结果失败");
            }
            body = response.getBody();
        } catch (AlipayApiException e) {
            e.printStackTrace();
           moocPlusException.cast("请求支付查询支付结果异常");
        }
    ...
    public void saveAliPayStatus(PayStatusDto payStatusDto){
        ...
        if(payRecordByPayno == null){
            moocPlusException.cast("找不到相关的支付记录");
        }
        //拿到相关联的订单id
        Long orderId = payRecordByPayno.getOrderId();
        XcOrders xcOrders = ordersMapper.selectById(orderId);
        if(xcOrders == null){
            moocPlusException.cast("找不到相关联的订单");
        }
        //支付状态
    ...
    public XcPayRecord createPayRecord(XcOrders orders){
        ...
        if(insert<=0){
            moocPlusException.cast("插入支付记录失败");
        }
        return xcPayRecord;
    }
